...
class BooksController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $updatedBook =Books::where('id',$id)->get();
        $updatedBook[0]['authors'] = json_decode($updatedBook[0]->authors,true);
        unset($updatedBook[0]->deleted_at);
        unset($updatedBook[0]->created_at);
        unset($updatedBook[0]->updated_at);
        return response()->json(['status_code'=>200,
            'status'=>'success',
